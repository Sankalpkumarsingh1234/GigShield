...
import ActuarialModelPanel from "./ActuarialModelPanel";
        ...
        <div style={{ background: "#fff", borderRadius: 14, border: "1px solid #E0D9D0", padding: "14px 16px", marginBottom: 14 }}>
          ...
          {insurerTab === "zones" && (
            <div style={{ overflow: "hidden" }}>
              <div style={{ padding: "0 0 10px", display: "flex", justifyContent: "space-between" }}>
          ...
          {insurerTab === "actuarial" && <ActuarialModelPanel />}
        </div>
      </div>
    </div>
  );
